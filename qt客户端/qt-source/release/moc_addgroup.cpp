...
QT_MOC_LITERAL(3, 34, 20) // "on_addButton_clicked"
    ...
    "AddGroup\0on_cancelButton_clicked\0\0"
...
void AddGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AddGroup *_t = static_cast<AddGroup *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject AddGroup::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AddGroup.data,
      qt_meta_data_AddGroup,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AddGroup::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddGroup.stringdata0))
        return static_cast<void*>(const_cast< AddGroup*>(this));
